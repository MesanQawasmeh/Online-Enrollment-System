...
<html  lang="en">
    <head>
    <meta charset="UTF-8">
    <title>انشاء كلمة سر جديدة</title>
        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="new-password.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="password" name="cpassword" placeholder=" تأكيد كلمة السر الجديدة" required>
                    </div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="change-password" value="تغيير ">
                    </div>
                </form>
            </div>
        </div>
